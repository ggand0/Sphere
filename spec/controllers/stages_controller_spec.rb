...
describe StagesController do
  before :each do
    file = fixture_file_upload('files/terrain0.json')
    jsonstring = file.read
    @valid_attributes = {
      scene_data: jsonstring,
      title: "testing title"
    }
  end
  ...
  let(:valid_attributes) { {
      ...
      texture: {
        stage: {
          textures: [fixture_file_upload('files/backgrounddetailed6.jpg', 'image/jpg')]
        }
      },
      title: "testing title"
    }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stage as @stage" do
        ...
        Stage.any_instance.stub(:save!).and_raise(ActiveRecord::RecordInvalid.new(Stage.new))
        post :create, { stage: valid_attributes }, valid_session
        assigns(:stage).should be_a_new(Stage)
      end
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested stage" do
        ...
        #Stage.any_instance.should_receive(:update).with({ "these" => "params" })
        Stage.any_instance.should_receive(:update_attributes).with( @updated_attr )
        puts @updated_attr
        #put :update, { id: stage.to_param, stage: { "these" => "params" }}, valid_session
        put :update, { id: stage.to_param, stage: @update_attr }, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the stage as @stage" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        #Stage.any_instance.stub(:save).and_return(false)
        Stage.any_instance.stub(:update_attributes!).and_raise(ActiveRecord::RecordInvalid.new(Stage.new))
        put :update, {:id => stage.to_param, stage: valid_attributes}, valid_session
        assigns(:stage).should eq(stage)
      end
